...
if st.session_state.input_locked:
    ...
    user_input = st.text_input("Skriv inn riktig kode for å låse opp flere sider:", type = "default").upper()
    ...
    if user_input:
        if user_input == "RØDBORGE":
            ...
            st.success("Riktig! Klikk på lenken under for å gå videre:")
            st.markdown('<a href="https://docs.google.com/document/d/1SkKj8cIl4oly4uVUKSnBAOWJJdiLgf9JCryLMK_rdJM/edit?usp=sharing" target="_blank">Klikk her for å gå videre</a>', unsafe_allow_html=True)
        ...
        elif user_input == "LARVIK STASJON":
            st.success("Riktig! Klikk på lenken under for å gå videre:")
